    ...
    <section class="contact-wrap">
      <div class="Barra">
        <ul>
          ...
          <li><a href="Responder.html"     class="icon-loop"></a></li>
                ...
                <td width="2%">
                  <form action="#">
                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                      ...
                      <label class="mdl-textfield__label" for="sample3">Ingrese Nombre</label>
                    </div>
                  </form>
                </td>
              </tr>
              ...
              <tr>
                <td width="2%">
                  <form action="#">
                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                      <input class="mdl-textfield__input" type="text" id="sample3">
                      <label class="mdl-textfield__label" for="sample3">Ingrese Apellido</label>
                    </div>
                  </form>
                </td>
              </tr>
